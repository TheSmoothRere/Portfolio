...
- `Gradient O1 (Blue to Light Blue)` --semantically_similar_to--> `Obsidian Blue`  [INFERRED] [semantically similar]
  public/favicon.svg → DESIGN.md
- `Gradient O3 (Dark Blue to Light Blue)` --semantically_similar_to--> `Obsidian Blue`  [INFERRED] [semantically similar]
  public/favicon.svg → DESIGN.md
- `Gradient O2 (Light Blue to Cyan)` --semantically_similar_to--> `Spring Green`  [INFERRED] [semantically similar]
  public/favicon.svg → DESIGN.md
- `Portfolio Logo (Favicon)` --represents--> `Cyber-Minimalist Portfolio`  [INFERRED]
  public/favicon.svg → DESIGN.md
- `React` --conceptually_related_to--> `Minimalist Cyberpunk`  [INFERRED]
  README.md → DESIGN.md

## Hyperedges (group relationships)
- **Design System Components** — design_neon-outline-button, design_print-pill, design_project-schematic-card, design_skills-network [EXTRACTED 1.00]
- **Typography System** — design_typography-display-xl, design_typography-display-xl-mobile, design_typography-display-lg, design_typography-headline-md, design_typography-body-base, design_typography-label-mono, design_typography-label-caps [EXTRACTED 1.00]

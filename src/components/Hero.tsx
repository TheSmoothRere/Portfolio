...
export default function Hero() {
  ...
  return (
    <section id="hero" className="min-h-screen flex flex-col justify-center items-center relative overflow-hidden pt-20">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-125 h-125 bg-spring-green/5 rounded-full blur-3xl -z-10 pointer-events-none" />
      ...
      >
        ...
        <motion.p variants={item} className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
          I'm a freelance developer and Minecraft modder with a passion for creating unique digital experiences. 
        ...
        <motion.div variants={item} className="flex flex-col md:flex-row gap-4 justify-center items-center">
          ...
          <div className="flex gap-6 md:ml-6 mt-4 md:mt-0">
             <a href="https://github.com/TheSmoothRere" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-spring-green hover:-translate-y-1 transition-all duration-300">
               <GithubLogoIcon size={32} />
             </a>
             <a href="https://www.linkedin.com/in/raehan-damai-putra/" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-spring-green hover:-translate-y-1 transition-all duration-300">
               <LinkedinLogoIcon size={32} />
             </a>
             <a href="mailto:thesmoothrere@gmail.com" className="text-gray-300 hover:text-spring-green hover:-translate-y-1 transition-all duration-300">

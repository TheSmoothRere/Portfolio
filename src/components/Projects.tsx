    ...
    <section id="projects" className="py-24 px-6 relative">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {PROJECTS.map((project, index) => (
            ...
            >
              ...
              <div className="absolute -top-8 left-8 w-px h-8 bg-gray-800 group-hover:bg-spring-green transition-colors duration-500"></div>
              <div className="absolute -top-1.25 left-7.25 w-1.5 h-1.5 rounded-full bg-gray-800 group-hover:bg-spring-green transition-colors duration-500"></div>

              {/* Project Header / Image Placeholder */}
              <div className="h-48 bg-gray-900 rounded-t-xl overflow-hidden relative border-b border-gray-800">
                {project.image ? (
                  <img
                    src={project.image}
                    alt={project.title}
                  ...
                  <div className="absolute inset-0 flex items-center justify-center text-gray-700 group-hover:text-spring-green/50 transition-colors">
                    <FolderIcon size={64} weight="thin" />
                  </div>
                )}
                {/* Overlay on hover */}
                <div className="absolute inset-0 bg-spring-green/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              </div>
        ...
        <div className="mt-16 text-center">
            <a href="https://github.com/TheSmoothRere" target="_blank" className="inline-block px-8 py-4 border border-spring-green text-spring-green font-mono rounded hover:bg-spring-green/10 transition-all duration-300">
